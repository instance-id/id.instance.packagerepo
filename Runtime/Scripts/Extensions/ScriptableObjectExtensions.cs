...
namespace instance.id.Extensions
{
    public static class ScriptableObjectExtensions
    {
        ...
        /// <summary>
        /// Create and save ScriptableObject Asset
        /// </summary>
        /// <param name="type">Derived type of ScriptableObject in which to create</param>
        /// <param name="filePath">The path in which to save the ScriptableObject Asset file</param>
        /// <param name="label">Asset labels to apply to the ScriptableObject Asset file to aid with searching and management</param>
        /// <typeparam name="T"></typeparam>
        /// <returns>ScriptableObject of Type T</returns>
        public static T CreateAsset<T>(this T type, string filePath = null, string[] label = null) where T : ScriptableObject
        {
            ...
            SaveAsset<ScriptableObject>(asset, assetPathAndName);
