...
namespace instance.id.Extensions
{
    public class ElementInspector
    {
        ...
        public ElementInspector(VisualElement root) => this.root = root;
        ...
        public void CreateVisualElementInspector(VisualElement root)
        {
        ...
        public void CreateTextElementInspector(VisualElement root)
        {
        ...
        public void CreateStyleInspector()
        {
        ...
        public VisualElement CreateInspectorArea(VisualElement root, string title)
        {
        ...
        public void CreateInspectorLine<T>(string label, T defaultValue, Action<T> onChange, VisualElement root)
        {
        ...
        public static void CreateEnumField<T>(T defaultValue, Action<T> onChange, VisualElement root, string label = null)
        {
