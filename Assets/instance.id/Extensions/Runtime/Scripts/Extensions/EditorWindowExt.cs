...
namespace instance.id.Extensions
{
    public static class EditorWindowExt
    {
		...
		public static bool WindowIsDocked([NotNull]this EditorWindow window)
		{
		...
		public static void AddTab([NotNull]this EditorWindow window, Type editorWindowType)
		{
			...
			var dockAreaType = TypeExtensions.GetInternalEditorType("UnityEditor.DockArea");
		...
		public static bool IsVisible([NotNull]this EditorWindow window)
		{
			...
			var hostViewType = TypeExtensions.GetInternalEditorType("UnityEditor.HostView");
		...
		public static void AddTab([NotNull]this EditorWindow window, EditorWindow tab)
		{
			...
			var types = ArrayTypePool<Type>.Create(2);
			types[1] = TypeExtensions.Bool;
			#else
			...
			ArrayTypePool<Type>.Dispose(ref types);
			#if UNITY_2018_3_OR_NEWER
			var parameters = ArrayTypePool<object>.Create(2);
			parameters[1] = true;
			#else
